...
## Metabase Style Guide (Summary)

Write like you're talking to a colleague. Be conversational, not formal. Get people what they need quickly. Use contractions ("can't" not "cannot"). Say "people" or "companies" instead of "users". Lead with the ask, then provide context. Backticks for code/variables, **bold** for UI elements. American spelling, serial commas. See `references/metabase-style-guide.md` for full guide.
...
- Run prettier on the file after making edits: `yarn prettier --write <file>`
