...
| 读取本地文件 | file-reader_read_file、file-reader_read_pdf 等 | 用户引用文件或需读取已有数据时使用（工作区文本用 file-reader_read_file） |
...
2. **收集数据**：
   ...
   - 需要「读文件」时：使用 file-reader_read_file（工作区文本）或 file-reader_read_pdf / read_docx / read_xlsx（PDF/DOCX/Excel）。
