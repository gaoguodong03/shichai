...
_SKILL_MCP_SERVERS_FALLBACK: Dict[str, List[str]] = {
    ...
    "article-review": ["filesystem"],
    "deep-research": ["linkup", "exa", "fetch", "zhipu-web-search", "filesystem"],
    "web-research": ["linkup", "exa", "fetch", "filesystem"],
    "doc-coauthoring": ["filesystem"],
    "docs-write": ["filesystem"],
    "xlsx": ["filesystem"],
    "math-assistant": ["calculator"],
    "group-host": ["filesystem"],
    "seminar-companion": [],
