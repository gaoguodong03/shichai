"""Skill stdout flow-control contract shared by expert runtimes.

This module carries only the current `skill_result.next_action` instruction
surface. Cross-turn state is derived in `group_chat_skill_session.py`; legacy
hidden state blocks and boolean "session over" parsing do not belong here.
"""
