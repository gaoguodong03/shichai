#!/usr/bin/env python3
"""网文配图图片生成 CLI。与 app-icon-generator 共用实现，供 run_skill_script 调用。

stdin：JSON 字符串，如 {"description": "……", "pic_size": "1792x1024"}，pic_size 可选默认 1024x1024。
stdout：工作区保存路径与下载链接或错误信息。
"""
import json
import os
import sys
