...
# Optional: pass an image tag to build/push ST49 image before packaging.
# Usage:
#   bash pack_1panel_backup.sh                 # only generate backup tarball
#   bash pack_1panel_backup.sh 26.04.27        # docker build + push, then package
